...
void Ch13Sample02::SetFrame(VectorTrack& track, int index, float time, const vec3& value) {
...
void Ch13Sample02::Render(float inAspectRatio) {
	vec3 cameraPos(
