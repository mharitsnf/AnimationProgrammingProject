...
void Ch13Sample01::SetFrame(VectorTrack& track, int index, float time, const vec3& value) {
...
void Ch13Sample01::Update(float deltaTime) {
	mPlayTime += deltaTime;
...
void Ch13Sample01::Render(float inAspectRatio) {
	vec3 cameraPos(
